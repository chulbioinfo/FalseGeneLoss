...
circos(cir=plot1_chr_db,R=360,W=0,mapping=plot1_chr_names_df,type="label", side="out",col=c("black"),order=plot1_chr_order, cex=0.8, lwd = 0)
circos(cir=plot1_chr_db,R=335,W=0,mapping=plot1_label_df,type="label", side="in", col=c("black"),order=plot1_chr_order, cex=0.8, lwd = 0)
circos(cir=plot1_chr_db,R=130,W=30,mapping=plot1_alignment_df,type="heatmap_for_aln",col=c("black"),order=plot1_chr_order, B=FALSE, cex=0.4, lwd= 1)
circos(cir=plot1_chr_db,R=170,W=15,mapping=plot1_missing_df,type="b3",col=c("black"),order=plot1_chr_order, cex=0.4, lwd= 0)
circos(cir=plot1_chr_db,mapping=plot1_gc_df,R=240,W=60,type="b2", cutoff=0.42, col=c("#fc3f6b","#bfbfbf"),lwd=0,order=plot1_chr_order, B=FALSE,scale=FALSE)
circos(cir=plot1_chr_db,mapping=plot1_repeat_df,R=200, W=60, type="b2",cutoff=0.20, col=c("#5c8dff","#bbc0c4"), lwd=0,order=plot1_chr_order, B=FALSE,scale=FALSE)
circos(cir=plot1_chr_db,mapping=plot1_genes_df, R=180, W=30, type="l",col=c("#ff752b"),order=plot1_chr_order, cex=0.4, lwd= 0.5, B=FALSE,scale = FALSE)
...
circos(cir=plot2_chr_db,R=360,W=0,mapping=plot2_chr_names_df,type="label", side="out",col=c("black"),order=plot2_chr_order, cex=0.8, lwd = 0)
circos(cir=plot2_chr_db,R=335,W=0,mapping=plot2_label_df,type="label", side="in", col=c("black"),order=plot2_chr_order, cex=0.8, lwd = 0)
circos(cir=plot2_chr_db,R=130,W=30,mapping=plot2_alignment_df,type="heatmap_for_aln",col=c("black"),order=plot2_chr_order, B=FALSE, cex=0.4, lwd= 1)
circos(cir=plot2_chr_db,R=170,W=15,mapping=plot2_missing_df,type="b3",col=c("black"),order=plot2_chr_order, cex=0.4, lwd= 0)
circos(cir=plot2_chr_db,mapping=plot2_gc_df,R=240,W=60,type="b2", cutoff=0.42, col=c("#fc3f6b","#bfbfbf"),lwd=0,order=plot2_chr_order, B=FALSE,scale=FALSE)
circos(cir=plot2_chr_db,mapping=plot2_repeat_df,R=200, W=60, type="b2",cutoff=0.20, col=c("#5c8dff","#bbc0c4"), lwd=0,order=plot2_chr_order, B=FALSE,scale=FALSE)
circos(cir=plot2_chr_db,mapping=plot2_genes_df, R=180, W=30, type="l",col=c("#ff752b"),order=plot2_chr_order, cex=0.4, lwd= 0.5, B=FALSE,scale = FALSE)
