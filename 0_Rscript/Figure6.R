...
zf_path <- "/disk1/juwan_d1/cat_rerun/zebra_finch/tm/CAT2MISSING_pre_taegut/total.count.tabs"
an_path <- "/disk1/juwan_d1/cat_rerun/anna/tm/CAT2MISSING_pre_calann/total.count.tabs"
pl_path <- "/disk1/juwan_d1/cat_rerun/platypus/tm/CAT2MISSING_pre_ornana/total.count.tabs"
cl_path <- "/disk1/juwan_d1/cat_rerun/climbing_perch/tm/CAT2MISSING_pre_anates/total.count.tabs"
...
# save plots
fig6.a_h.filepath <- "/disk1/juwan_d1/cat_rerun/1_Main_figures/Fig6/fig6.a_h.png"
ggsave(fig6.a_h.filepath, fig6.a_h + theme(legend.position = "none"), width=3, height=4.5)
# save legend
fig6.a_h.legend_filepath <- "/disk1/juwan_d1/cat_rerun/1_Main_figures/Fig6/fig6.a_h.legend.png"
...
# input dataframes
zf_ratio_path <- "/disk1/juwan_d1/cat_rerun/zebra_finch/tm/CAT2MISSING_pre_taegut/total.summary.tsv"
an_ratio_path <- "/disk1/juwan_d1/cat_rerun/anna/tm/CAT2MISSING_pre_calann/total.summary.tsv"
pl_ratio_path <- "/disk1/juwan_d1/cat_rerun/platypus/tm/CAT2MISSING_pre_ornana/total.summary.tsv"
cl_ratio_path <- "/disk1/juwan_d1/cat_rerun/climbing_perch/tm/CAT2MISSING_pre_anates/total.summary.tsv"
...
fig6.i.filepath <- "/disk1/juwan_d1/cat_rerun/1_Main_figures/Fig6/fig6.i.png"
