...
repeat_test_maker <- function (repeat_type) {
  # load dataframe
  whole_genome_path <- paste0("/disk3/juwan_d3/cactus_results/13_bTaeGut1_v1.p_bTaeGut2.pat.W.p2/bTaeGut2.10000.", repeat_type, ".bed")
  chr19_path <- paste0("/disk3/juwan_d3/cactus_results/13_bTaeGut1_v1.p_bTaeGut2.pat.W.p2/bTaeGut2.chr19.10000.", repeat_type, ".bed")
  missing_chr19_path <- paste0("/disk3/juwan_d3/cactus_results/13_bTaeGut1_v1.p_bTaeGut2.pat.W.p2/bTaeGut2.missing_chr19.10000.", repeat_type, ".bed")
  ...
  # draw plot
  fig.8.b.plot <- ggplot(whole_vs_chr19, aes(x =genome_type, y = overlap, fill = genome_type, group =genome_type, color=genome_type))+
    ...
    #stat_compare_means(ref.group = "Missing 2.7 Mbp",
    #                   label = "p.signif",size=1.5,
    #                   method="wilcox.test",
    #                   label.y= y_manual_lim*0.85, hide.ns=TRUE) + 
  ...
  fig.8.b.legend = gtable_filter(ggplotGrob(fig.8.b.plot), "guide-box")
  fig.8.b.legend_plot <- arrangeGrob(fig.8.b.legend)
  fig.8.b.filepath <- "/disk1/juwan_d1/cat_rerun/1_Main_figures/Fig8/fig8.legend.png"
  ggsave(fig.8.b.filepath, fig.8.b.legend_plot, width=3, height=1,units = "in")
  fig.8.b.plot <- fig.8.b.plot + theme(legend.position="none")
  my_list <- list(fig.8.b.plot)
  return(my_list)
}
...
# merge all plots
fig8.plot.list <- c(LINE_plot_list, LTR_plot_list,
                    SINE_plot_list, Simple_repeat_plot_list, Low_complexity_plot_list)
my_layout<-rbind(c(1,2,3,4,5), c(1,2,3,4,5))
fig8.f.plots <- arrangeGrob(grobs = fig8.plot.list, layout_matrix = my_layout)

# save output file
fig8.f.plots_out <-"/disk1/juwan_d1/cat_rerun/1_Main_figures/Fig8/fig8.b.png"
ggsave(fig8.f.plots_out, fig8.f.plots, width=4.0, height=1.6)
