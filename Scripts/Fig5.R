...
input_path <- "./input/"
output_path <- "./"
average_gc_miss_path <- paste0(input_path, "input.gc_and_indel.tsv")
...
fig5.a_b.zf_SNP_filepath <- paste0(output_path, "fig5.a_d.zebra_finch.SNP.png")
...
fig5.a_b.an_SNP_filepath <- paste0(output_path, "fig5.a_d.anna.SNP.png")
...
fig5.a_b.zf_indel_filepath <- paste0(output_path, "fig5.a_d.zebra_finch.indel.png")
...
fig5.a_b.an_indel_filepath <- paste0(output_path, "fig5.a_d.anna.indel.png")
