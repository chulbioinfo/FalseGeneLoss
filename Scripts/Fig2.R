...
set.seed(1234)
trace(circos,edit=T) # Manual edit of source code to change the display

# mapping data
chr_df <- read.csv("./input/chromosomes.size.csv")
gc_df <- read.csv("./input/chromosomes.gc.csv")
repeat_df <- read.csv("./input/chromosomes.repeat.csv")
missing_df <- read.csv("./input/chromosomes.missing_loci.csv")
label_df <- read.csv("./input/chromosomes.missing_label.csv")
chr_names_df <- read.csv("./input/chromosomes.name.csv")
gaps_df <- read.csv("./input/vgp_gap_plot.csv")
alignment_df <- read.csv("./input/chromosomes.aln.csv")
genes_df <- read.csv("./input/vgp_genes_plot.csv")
